! function (e, n, t) {
    ...
    3: [function (e) {
        ...
        function i(e, n, t, r, o, i, a) {
            if (p += 1, l.info.beacon) {
                var u = l.proto + l.info.beacon + "/1/" + l.info.licenseKey;
                u += "?a=" + l.info.applicationID + "&", u += "t=" + n + "&", u += "qt=" + t + "&", u += "ap=" + r + "&", u += "be=" + o + "&", u += "dc=" + i + "&", u += "fe=" + a + "&", u += "c=" + p, c({
                    url: u
                })
            }
        }
    ...
    6: [function (e, n) {
        ...
        function i(e, n) {
            for (var t = d({}), r = d({}), o = k[e] || [], i = 0; i < o.length; i++) {
                var a = o[i](n);
    ...
    8: [function (e) {
        ...
        var r = e(1),
            ...
            c = (e(8), e("loader")),
            d = e("ee"),
            l = "undefined" != typeof window.NREUM.autorun ? window.NREUM.autorun : !0;
        window.NREUM.setToken = n, c.maxBytes = 6 === e(5) ? 2e3 : 3e4;
        var m = u(t);
        o("beforeunload", m), o("pagehide", m), o("unload", function () {
            s.sendAll(c, !1)
        }), f("mark", a.mark), a.mark("done"), l && s.sendBeacon(c, a)
    }, {
        1: 11,
        10: 12,
        2: 1,
    ...
    17: [function (e, n) {
        ...
        function r(e) {
            ...
            return n.frames.length ? {
                ...
                name: e.name || s(e),
                message: e.message,
                stackString: c(n.stackLines.join("\n")),
                frames: n.frames
            } : null
        }
        ...
        function i(e) {
            var n = e.match(y);
            return n || (n = e.match(w)), n ? {
                url: n[2],
                func: "Anonymous function" !== n[1] && n[1] || null,
                line: +n[3],
                column: n[4] ? +n[4] : null
            } : e.match(b) || e.match(x) || "anonymous" === e ? {
                func: "evaluated code"
            } : void 0
        }
        ...
        function s(e) {
            var n = v.exec(String(e.constructor));
        ...
        function d(e) {
            for (var n, t = e.stacktrace, r = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, o = t.split("\n"), i = [], a = [], u = !1, d = 0, l = o.length; l > d; d += 2)
                if (n = r.exec(o[d])) {
                    ...
                    f(m.func) ? u = !0 : a.push(o[d]), u || i.push(m)
                } else a.push(o[d]);
            return i.length ? {
                mode: "stacktrace",
                name: e.name || s(e),
                message: e.message,
                stackString: c(a.join("\n")),
                frames: i
            } : null
        }
        ...
        function l(e) {
            ...
            var t, r, o, i = /^\s*Line (\d+) of linked script ((?:file|http|https)\S+)(?:: in function (\S+))?\s*$/i,
                ...
                h = [],
                v = !1;
            for (r in m) p.call(m, r) && !m[r].src && h.push(m[r]);
            for (r = 2, o = n.length; o > r; r += 2) {
                ...
                g && (f(g.func) ? v = !0 : l.push(n[r]), v || d.push(g))
            }
            return d.length ? {
                mode: "multiline",
                name: e.name || s(e),
                message: n[0],
                stackString: c(l.join("\n")),
                frames: d
            } : null
        }
        var m = e(1),
            ...
            v = /function (.+)\(/,
            g = /^\n+|\n+$/g,
            w = /^\s*at (?:((?:\[object object\])?(?:[^(]*\([^)]*\))*[^()]*(?: \[as \S+\])?) )?\(?((?:file|http|https|chrome-extension):.*?)?:(\d+)(?::(\d+))?\)?\s*$/i,
    ...
    18: [function (e, n) {
        ...
        function r(e, n, r) {
            ...
            for (var d = "", p = 0; p < o.frames.length; p++) {
                var h = o.frames[p],
                    v = a(h.func);
                d && (d += "\n"), v && (d += v + "@"), "string" == typeof h.url && (h.url = h.url.split("?")[0], h.url === c.origin && (h.url = "<inline>"), d += h.url), h.line && (d += ":" + h.line)
            }
            var g = {
                stackHash: f(d),
            ...
            if (o.message && (g.message = o.message), l[g.stackHash] ? g.browser_stack_hash = f(o.stackString) : (l[g.stackHash] = !0, g.stack_trace = o.stackString), document.referrer) {
    ...
    20: [function (e) {
        function n(e, n, t) {
            ...
            if (!(c || p.length >= l)) {
                ...
                a(h, o), a(m, o), t.eventType = "PageAction", t.actionName = n, a(t, function (e, n) {
        ...
        document.referrer && (r = d(document.referrer)), s("api-setCustomAttribute", t), s("api-addPageAction", n);
        var g = !1;
    ...
    21: [function (e, n) {
        ...
        function a(e, n) {
            ...
            } else e && "string" == typeof e.tagName && (t = e.tagName.toLowerCase(), e.id && (t += "#" + e.id), e.className && (t += "." + S(e.classList).join(".")));
        ...
        function l() {
            ...
            var e = E(k(R, function (e, n) {
                return e in L ? E(k(E(n.sort(m), p(e), {}), h), v, []) : n
            }), v, []);
        ...
        if (n.exports = {
            ...
            C.on("rates", function (e) {
                if (!M && e && e.stn) {
                    M = !0, clearTimeout(_), t(window.performance.timing), b.on("resources", d(l));
                    ...
                    n.addEventListener("load", function () {
                        ...
                        var e = 0;
                        return Date.now() - x.offset > 9e5 ? void(R = {}) : (k(R, function (n, t) {
    ...
    22: [function (e, n) {
        ...
        if (s.features.xhr) {
            ...
            f.on("rates", function (e) {
                !d && e && e.err && (d = !0, clearTimeout(c), i("xhr", t))
            }), n.exports = t
        }
    }, {
        1: 2,
